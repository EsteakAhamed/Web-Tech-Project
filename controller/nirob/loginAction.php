<?php
session_start();
require("../../model/nirob/loginmodel.php");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($isValid) {
        ...
        if ($user) {
            ...
            header("Location: ../../view/nirob/home.php"); // Dashboard page
            exit();
        } else {
            // Failed login
            ...
            header("Location: ../../view/nirob/login.php"); // Back to login page
            exit();
        }
    } else {
        // Validation failed, stay on login page
        header("Location: ../../views/nirob/login.php");
        exit();
    }
}
?>
