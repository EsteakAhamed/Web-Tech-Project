...
<body>
  ...
  <div class="forgot-card <?php echo isset($_SESSION['forgot_success']) ? 'success' : ''; ?>">
    ...
    <!-- Step 1: Email -->
    <form action="../../controller/nirob/ForgotAction.php" method="post">
    ...
    <form action="../../controller/nirob/OTPAction.php" method="post" id="otpForm">
    ...
    <form action="../../controller/nirob/RecoverAction.php" method="post" id="recoverForm" class="recover-container">
